...
export default class RatingPanel {
    constructor(scene, x, y, trialType) {
    this.scene = scene;
    ...
    slider
        ...
        dialog
            .once('button.click', function (button, groupName, index) {
                let rating = Math.round(slider.getValue(1, 100)); //get final slider value
...
var createNumberBar = function (scene) {
    var numberBar = scene.rexUI.add.numberBar({ 
        ...
        icon: scene.rexUI.add.BBCodeText(0, 0, 'lose\npearls', {halign: 'center'}),
...
//        }),       
        text: scene.rexUI.add.BBCodeText(0, 0, 'keep\npearls', {halign: 'center'}),
